var saveDates = function() {
    ...
    chrome.storage.local.set({
        ...
        'saveStories': (document.getElementById('saveStories').checked ? 'true': 'false')
    });
...
var restoreDates = function() {
    ...
    chrome.storage.local.get(null, function (items) {  
        ...
        if (items.saveStories) {
            document.getElementById('saveStories').checked = (items.saveStories == 'true' ? true: false);
        }
    });
};
